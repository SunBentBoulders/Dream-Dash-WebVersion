window.createGame = function(scope, mapId, injector) {
...
// (function() {
            ...
            window.mobilecheck = function() {
                var check = false;
                // this one checks for most mobile only - next one checks for most mobile and tablets
                ...
                // this one checks for most mobile and tablets
            ...
            game.state.add('Preloader', Preloader); //does not transfer
            // game.state.add('Game', Game); //game.js
