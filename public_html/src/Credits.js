...
Credits.prototype = {
    ...
    addCredit: function(task, author) {
        var authorStyle = {
            font: this.game.width / 20 + 'pt TheMinion',
            fill: 'white',
            align: 'center',
            stroke: 'rgba(0,0,0,0)',
            strokeThickness: 4
        ...
        this.add.tween(authorText).to({
            y: -300
        }, 20000, Phaser.Easing.Cubic.Out, true, this.creditCount * 5000);
        this.add.tween(taskText).to({
            y: -200
        }, 20000, Phaser.Easing.Cubic.Out, true, this.creditCount * 5000);
        this.creditCount++;
    },
    ...
    addMobileCreditButton: function(task, author) {
        ...
        this.add.tween(authorButton).to({
            y: -300
        }, 20000, Phaser.Easing.Cubic.Out, true, this.creditCount * 5000);
        this.add.tween(taskButton).to({
            y: -200
        }, 20000, Phaser.Easing.Cubic.Out, true, this.creditCount * 5000);
        this.creditCount++;
    },
    ...
    create: function() {
        ...
        this.game.add.tween(bg).to({
            alpha: 0
        }, 20000, Phaser.Easing.Cubic.Out, true, 10000);
    }
